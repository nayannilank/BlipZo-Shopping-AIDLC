...
export function useCart(): UseQueryResult<CartResponse> {
...
export function useRemoveCartItem(): UseMutationResult<CartResponse, Error, string> {
  const queryClient = useQueryClient();
...
export function useClearCart(): UseMutationResult<CartResponse, Error, void> {
  const queryClient = useQueryClient();
