 ...
 */
const rawGetCartHandler = async (event) => {
 ...
 */
const rawPutCartItemHandler = async (event) => {
    const buyerId = extractBuyerId(event);
 ...
 */
const rawRemoveCartItemHandler = async (event) => {
    const buyerId = extractBuyerId(event);
 ...
 */
const rawClearCartHandler = async (event) => {
    const buyerId = extractBuyerId(event);
