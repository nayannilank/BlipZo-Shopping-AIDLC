...
export declare const addToWishlistHandler: middy.MiddyfiedHandler<import("@middy/http-json-body-parser").RequestEvent & APIGatewayProxyEvent, APIGatewayProxyResult, Error, import("aws-lambda").Context, {}>;
