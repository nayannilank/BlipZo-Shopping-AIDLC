...
export function createValidationError(fields) {
    ...
    error['code'] = ADDRESS_ERROR_CODES.VALIDATION_ERROR;
    error['fields'] = fields;
    throw error;
}
/**
...
export function createUnauthorizedError(message = 'Unauthorized') {
    ...
    error['code'] = ADDRESS_ERROR_CODES.UNAUTHORIZED;
    throw error;
}
/**
...
export function createNotFoundError(message) {
    ...
    error['code'] = ADDRESS_ERROR_CODES.NOT_FOUND;
    throw error;
}
/**
...
export function createServiceUnavailableError() {
    ...
    error['code'] = ADDRESS_ERROR_CODES.SERVICE_UNAVAILABLE;
    throw error;
}
