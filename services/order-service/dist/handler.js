...
import { cancelOrder, checkout, createReturnExchangeRequest, getOrderDetail, getOrderHistory, getReturnExchangeRequestDetail, } from './service.js';
import { extractBuyerId, extractOrderHistoryParams, extractOrderId, extractRequestId, validateCheckoutInput, validateReturnExchangeInput, } from './validators.js';
/**
 ...
 * Requirements: 12.1
 */
const rawOrderHistoryHandler = async (event) => {
    const buyerId = extractBuyerId(event);
 ...
 */
const rawOrderDetailHandler = async (event) => {
    const buyerId = extractBuyerId(event);
 ...
 */
const rawCancelOrderHandler = async (event) => {
    const buyerId = extractBuyerId(event);
    const orderId = extractOrderId(event);
 ...
 */
const rawReturnExchangeHandler = async (event) => {
    const buyerId = extractBuyerId(event);
    const orderId = extractOrderId(event);
 ...
 * Requirements: 13.4
 */
const rawGetReturnExchangeHandler = async (event) => {
    const buyerId = extractBuyerId(event);
