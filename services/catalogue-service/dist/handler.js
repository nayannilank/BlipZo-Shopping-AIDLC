...
import { listCategories, listProductsByCategory, getProductDetail, searchProducts, } from './service.js';
import { extractCategoryId, extractProductId, extractPaginationParams, extractSearchParams, } from './validators.js';
/**
 ...
 */
const rawGetProductDetailHandler = async (event) => {
 ...
 */
const rawSearchProductsHandler = async (event) => {
