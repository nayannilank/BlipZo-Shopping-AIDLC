import type { PaymentRequest, MockPaymentDetails } from '@blipzo/shared';
import { z } from 'zod';
 ...
 */
const SUPPORTED_METHODS = ['UPI', 'CreditCard', 'DebitCard', 'CashOnDelivery'] as const;
 ...
 * Requirements: 11.3
 */
export function validatePaymentRequest(payload: unknown): PaymentRequest {
